# -*- coding: utf-8 -*-
{
    ...
    'summary': """ViettelPost Integration module will allow shippers to easily place, cancel, get quotes, and track orders via simple integration for delivery in Odoo.""",
