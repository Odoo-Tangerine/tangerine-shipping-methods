    ...
    def _onchange_express_247_provider(self):
        for rec in self:
            if rec.carrier_id and rec.carrier_id.delivery_type == settings.code.value:
                rec.express_247_is_inspection_goods_allowed = rec.carrier_id.default_express_247_is_inspection_goods_allowed
                rec.express_247_service_type_id = rec.carrier_id.default_express_247_service_type_id
                rec.express_247_special_service_type_id = rec.carrier_id.default_express_247_special_service_type_id
